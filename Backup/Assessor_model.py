...
class Experiment:
    ...
    def procede_adaptive_assessment(self,n_cluster,n_object_per_assessment):
        ...
        set_of_objects_ind=self.adaptive_method.objects_generator(self.results,len(self.set_of_assessors),len(self.set_of_objects),n_object_per_assessment)
...
class Adaptive_method:
    ...
    def objects_generator(self,results,n_assessors,n_objects,n_object_per_assessment):
        return self.objects_generator_function(results,n_assessors,n_objects,n_object_per_assessment)
